...
const getUploadedImages_1 = require("../create/helpers/getUploadedImages");
const getUploadedVideos_1 = require("../create/helpers/getUploadedVideos");
const deleteFiles_1 = require("../create/helpers/deleteFiles");
...
const createTestimonial = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const testimonialCoreResult = yield supabase_1.supabase.schema("testimonials").from("testimonials").insert(Object.assign(Object.assign({}, testimonialCoreData), { testimonial_id: testimonialId }));
        ReturnError(res, "Error inserting testimonial core data into Supabase", testimonialCoreResult.error);
        const testimonialMediaUploadResult = yield supabase_1.supabase.schema("testimonials").from("testimonial_media").insert(Object.assign(Object.assign({}, testimonialMediaData), { testimonial_id: testimonialId }));
        ReturnError(res, "Error inserting testimonial media data into Supabase", testimonialMediaUploadResult.error);
        const testimonialActivityResult = yield supabase_1.supabase.schema("testimonials").from("testimonial_activities").insert({ activities: activites, testimonial_id: testimonialId });
        ReturnError(res, "Error inserting testimonial activity data into Supabase", testimonialActivityResult.error);
        const testimonialTagsResult = yield supabase_1.supabase.schema("testimonials").from("testimonial_tags").insert({ travel_tags: travel_tags, testimonial_id: testimonialId });
