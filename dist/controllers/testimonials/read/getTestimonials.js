...
const getTestimonials = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { count } = yield supabase_1.supabase.schema("testimonials").from("testimonials").select("id", { count: "exact" });
        let query = supabase_1.supabase.schema("testimonials").from("testimonials").select("*, testimonial_media(photos, videos), testimonial_activities(activities), testimonial_tags(travel_tags)");
