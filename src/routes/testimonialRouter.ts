...
import { createTestimonial } from "../controllers/testimonials/delete/createTestimonial";
...
import { fetchMyTestimonials } from "../controllers/testimonials/read/fetchMyTestimonials";
import { uploadWebhook } from "../controllers/webhooks/uploadWebhook";
import { createTodo } from "../controllers/webhooks/createTodos";
...
testimonialRouter.post("/webhook/upload", uploadWebhook);
testimonialRouter.post("/todos", createTodo);

testimonialRouter.get("/", getTestimonials);
testimonialRouter.get("/myTestimonials", fetchMyTestimonials);
